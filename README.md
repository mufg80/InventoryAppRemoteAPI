...
For development with HTTPS, ensure the localhost.pfx certificate (password: kyleink1) is available, or generate a new one using:
bash

dotnet dev-certs https

Restore dependencies and build the project using:
bash
